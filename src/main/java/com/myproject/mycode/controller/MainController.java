...
import com.myproject.mycode.model.*;
import com.myproject.mycode.service.*;
...
public class MainController {
	...
	public String mainpage(freeboard freeboard, QnaBoard qnaBoard, StudyBoard studyBoard, NoticeBoardModel noticeBoard, Model model) {

		List<freeboard> freeList = freeservice.mainFreeList(freeboard);
		List<QnaBoard> qnaList = qnaservice.mainQnaList(qnaBoard);
		List<StudyBoard> studyList = studyservice.mainStudyList(studyBoard);
		List<NoticeBoardModel> noticeList = noticeservice.mainNoticeList(noticeBoard);

		model.addAttribute("freeMainList", freeList);
		model.addAttribute("qnaMainList", qnaList);
		model.addAttribute("studyMainList", studyList);
		model.addAttribute("noticeMainList", noticeList);
		return "main";
	}
